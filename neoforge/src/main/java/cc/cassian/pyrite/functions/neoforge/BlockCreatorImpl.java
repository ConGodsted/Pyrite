    ...
    public static void platformRegister(String blockID, String blockType, AbstractBlock.Settings settings, WoodType woodType, BlockSetType blockSetType, ParticleEffect particle, Block copyBlock) {
        ...
        switch (blockType.toLowerCase()) {
            ...
            case "flower":
                ...
                var pot = BLOCKS.register("potted_"+blockID, () -> new FlowerPotBlock(() -> (FlowerPotBlock), newBlock, AbstractBlock.Settings.create().breakInstantly().nonOpaque().pistonBehavior(PistonBehavior.DESTROY).registryKey(registryKeyBlock("potted_"+blockID))));
